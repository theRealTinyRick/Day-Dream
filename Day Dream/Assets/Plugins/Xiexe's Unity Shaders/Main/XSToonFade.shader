...
Shader "Xiexe/Toon/XSToonFade"
{
	...
	//Enums for all options
		...
		[Enum(PBR,0,Stylized,1)] _ReflType ("Reflection Type", Int) = 0
		...
		_StylelizedIntensity("Stylized Refl Intensity", Range(0,20)) = 1
	...
	SubShader
	{
		...
		#pragma shader_feature _ _MIXEDREFLECTION_ON
